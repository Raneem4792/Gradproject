...
class _MealFormSheetState extends State<_MealFormSheet> {
  ...
  void initState() {
    ...
    _cal = TextEditingController(
      text: widget.initial?.calories.toString() ?? "0",
    );
    _pro = TextEditingController(
      text: widget.initial?.protein.toString() ?? "0",
    );
    _carb = TextEditingController(
      text: widget.initial?.carbohydrates.toString() ?? "0",
    );
